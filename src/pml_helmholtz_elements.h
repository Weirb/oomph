...
public:
  ...
  QPMLHelmholtzElement() : QElement<DIM, NNODE_1D>(), PMLHelmholtzEquations<DIM>()
  {
  }
...
//=======================================================================
template <unsigned DIM, unsigned NNODE_1D>
class FaceGeometry<QPMLHelmholtzElement<DIM, NNODE_1D>> : public virtual QElement<DIM - 1, NNODE_1D>
{
...
class FaceGeometry<QPMLHelmholtzElement<1, NNODE_1D>> : public virtual PointElement
{
...
class ProjectablePMLHelmholtzElement : public virtual ProjectableElement<HELMHOLTZ_ELEMENT>
{
...
class PMLLayerElement<
    QPMLHelmholtzElement<2, NNODE_1D>> : public virtual QPMLHelmholtzElement<2, NNODE_1D>
{
