...
//LIC//
//LIC//    Version 1.0; svn revision $LastChangedRevision: 1288 $
//LIC//
//LIC// $LastChangedDate: 2017-02-14 13:42:45 +0000 (Tue, 14 Feb 2017) $
//LIC//
...
void PMLFourierDecomposedHelmholtzEquations::
    fill_in_generic_residual_contribution_pml_fourier_decomposed_helmholtz(Vector<double> &residuals,
                                                                           ...
                                                                           const unsigned &flag)
{
  ...
  for (unsigned ipt = 0; ipt < n_intpt; ipt++)
  {
    ...
    double J =
        dshape_and_dtest_eulerian_at_knot_pml_fourier_decomposed_helmholtz(ipt, psi, dpsidx, test, dtestdx);
    ...
    for (unsigned l = 0; l < n_node; l++)
    {
      ...
      const std::complex<double> u_value(
          ...
          raw_nodal_value(l, u_index_pml_fourier_decomposed_helmholtz().imag()));
    ...
    for (unsigned l = 0; l < n_node; l++)
    {
      ...
      if (local_eqn_real >= 0)
      {
        ...
        if (flag)
        {
          ...
          for (unsigned l2 = 0; l2 < n_node; l2++)
          {
            ...
            local_unknown_real =
                nodal_local_eqn(l2, u_index_pml_fourier_decomposed_helmholtz().real());
            local_unknown_imag =
                nodal_local_eqn(l2, u_index_pml_fourier_decomposed_helmholtz().imag());
      ...
      if (local_eqn_imag >= 0)
      {
        ...
        if (flag)
        {
          ...
          for (unsigned l2 = 0; l2 < n_node; l2++)
          {
            local_unknown_imag = nodal_local_eqn(l2, u_index_pml_fourier_decomposed_helmholtz().imag());
            local_unknown_real =
                nodal_local_eqn(l2, u_index_pml_fourier_decomposed_helmholtz().real());
...
//======================================================================
void PMLFourierDecomposedHelmholtzEquations::output(std::ostream &outfile,
...
//======================================================================
void PMLFourierDecomposedHelmholtzEquations::output_real(std::ostream &outfile,
                                                         const double &phi,
                                                         const unsigned &nplot)
{
  //Vector of local coordinates
...
//======================================================================
void PMLFourierDecomposedHelmholtzEquations::compute_norm(double &norm)
{
