...
//LIC//
//LIC//    Version 1.0; svn revision $LastChangedRevision: 1299 $
//LIC//
//LIC// $LastChangedDate: 2017-10-06 07:40:18 +0100 (Fri, 06 Oct 2017) $
//LIC//
...
//=======================================================================
class BermudezPMLMappingAndTransformedCoordinate : public PMLMappingAndTransformedCoordinate
{
...
public:
                             ...
                             const double &k_squared)
  {
    ...
    return 1.0 + std::complex<double>(1.0 / sqrt(k_squared), 0) * std::complex<double>(0.0, 1.0 / (std::fabs(pml_width_i - nu_i)));
  }
...
//=============================================================
class PMLFourierDecomposedHelmholtzEquations : public virtual PMLElementBase<2>,
                ...
                Vector<std::complex<double>> &flux) const
  {
    ...
    for (unsigned l = 0; l < n_node; l++)
    {
      ...
      const std::complex<double> u_value(
          this->nodal_value(l, u_index_pml_fourier_decomposed_helmholtz().real()),
          this->nodal_value(l, u_index_pml_fourier_decomposed_helmholtz().imag()));
      ...
      std::complex<double> &pml_k_squared_factor)
  {
    ...
    if (this->Pml_is_enabled)
    {
      ...
      for (unsigned k = 0; k < 2; k++)
      {
        ...
        {
          pml_gamma[k] = Pml_mapping_and_transformed_coordinate_pt->gamma(nu[k], pml_width[k], k_squared_local);
        }
        else
        {
          pml_gamma[k] = 1.0;
...
class QPMLFourierDecomposedHelmholtzElement : public virtual QElement<2, NNODE_1D>,
...
public:
  ...
  QPMLFourierDecomposedHelmholtzElement() : QElement<2, NNODE_1D>(), PMLFourierDecomposedHelmholtzEquations()
  {
  }
  ...
  void output_real_fct(std::ostream &outfile,
                       ...
                       FiniteElement::SteadyExactSolutionFctPt exact_soln_pt)
  {
    PMLFourierDecomposedHelmholtzEquations::output_real_fct(outfile, phi,
  ...
  void output_fct(std::ostream &outfile, const unsigned &n_plot,
                  ...
                  FiniteElement::UnsteadyExactSolutionFctPt exact_soln_pt)
  {
    PMLFourierDecomposedHelmholtzEquations::output_fct(outfile, n_plot, time, exact_soln_pt);
  }
...
//=======================================================================
template <unsigned NNODE_1D>
class FaceGeometry<QPMLFourierDecomposedHelmholtzElement<NNODE_1D>> : public virtual QElement<1, NNODE_1D>
{
...
class ProjectablePMLFourierDecomposedHelmholtzElement : public virtual ProjectableElement<FOURIER_DECOMPOSED_HELMHOLTZ_ELEMENT>
{
...
public:
                                     ...
                                     Shape &psi)
  {
    ...
    double J = this->dshape_and_dtest_eulerian_pml_fourier_decomposed_helmholtz(
        s, psi, dpsidx,
        test, dtestdx);
    return J;
  }
...
class PMLLayerElement<
    QPMLFourierDecomposedHelmholtzElement<NNODE_1D>> : public virtual QPMLFourierDecomposedHelmholtzElement<NNODE_1D>
{
